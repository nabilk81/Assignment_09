...
# NKnight, 2022-Mar-27, Added track getters and setters and methods
#------------------------------------------#
...
class Track():
    ...
    # --- Constructor --- #
    def __init__(self, pos, titl, leng):
        self.__position = pos
        self.__title = titl
        self.__length = leng
...
class CD:
    ...
    def add_track(self, track: Track) -> None:
        ...
        """
        # TODone append track
        #Accidentally, saw this when watching the video before starting assignment
