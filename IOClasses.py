...
# NKnight, 2022-Mar-27, Updating program to load and save both files
#------------------------------------------#
...
class FileIO:
    ...
    def save_inventory(file_name: list, lst_Inventory: list) -> None:
        ...
        try:
            ...
            #was unsure how to do this, so referenced Dirks code - shouldnt get credit for this
    ...
    def load_inventory(file_name: list) -> list:
        ...
        try:
            ...
            with open(file_name_Tracks, 'r') as file:
                #this was my attempt but it wasnt working, shouldnt get credit for this
                #for line in file:
                    #trk_data = line.strip().split('.')
                    #row = DC.Track(trk_data[0], trk_data[1], trk_data[2])
                    #if row[0] == lst_Inventory[0]:
                        #lst_Inventory.append(row)
                for line in file:
                    data = line.strip().split(',')
